...
class ConversationalTeacher:
    ...
    def __init__(self, config_path: Optional[str] = None):
        ...
        self.voice_interface = VoiceInterface(
            ...
            auto_listen=self.config.voice.auto_listen
        )
    ...
    def start_session(self) -> None:
        ...
        print(f"Voice Interface: {'Enabled' if self.config.voice.enabled else 'Disabled'}")
        print(f"{'='*60}\n")
    ...
    def end_session(self) -> None:
        ...
        if (self.config.statistics.export_to_anki and 
            self.statistics.vocabulary_stats.total_words > 0):
            ...
            while True:
                ...
                if error_result.has_errors:
                    ...
                    for i, error in enumerate(error_result.errors, 1):
                        print(f"  {i}. {error.error_type}: '{error.incorrect_text}' → '{error.corrected_text}'")
    ...
    def export_vocabulary(self, filepath: Optional[str] = None) -> None:
        ...
        self.anki_exporter.export_to_csv(
            self.statistics.vocabulary_stats.vocabulary_list,
            filepath
        )
    ...
    def show_statistics(self) -> None:
        ...
        if summary['vocabulary_statistics']['by_difficulty']:
            print("  By difficulty:")
            for difficulty, count in summary['vocabulary_statistics']['by_difficulty'].items():
