...
class StatisticsTracker:
    ...
    def record_vocabulary(self, vocabulary: List[VocabularyItem]) -> None:
        ...
        for item in vocabulary:
            ...
            if not any(
                v.word == item.word for v in self.vocabulary_stats.vocabulary_list
            ):
    ...
    def get_summary(self) -> Dict:
        ...
        return {
            ...
            "current_session": {
                ...
                "messages": self.current_session.messages_exchanged
                if self.current_session
                else 0,
                "errors": self.current_session.errors_made
                if self.current_session
                else 0,
                "words": self.current_session.words_learned
                if self.current_session
                else 0,
            }
            if self.current_session
